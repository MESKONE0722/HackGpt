...
class Config:
    ...
    def __init__(self, config_file: str = "config.ini"):
        ...
        self.DATABASE_URL = os.getenv("DATABASE_URL", self.config.get("database", "url", fallback="postgresql://db_user:db_password@localhost:5432/hackgpt"))
    ...
    def create_default_config(self):
        ...
        self.config.set("database", "url", "postgresql://db_user:db_password@localhost:5432/hackgpt")
